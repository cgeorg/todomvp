...
/***/ function(module, exports, __webpack_require__) {
	...
	function calculatePurchaseOptions(model) {
	  ...
	  model.purchaseOptions = _(addPizza({ pizzas: [], total: 0 }, [])).tap(function (options) {
	    ...
	    return options.length && (options[options.length - 1].special = "Most pizza! ");
	  }).sortBy("ratio").tap(function (options) {
	    return options.length && (options[0].special = (options[0].special ? options[0].special : "") + "Best deal!");
	  }).sortBy(sortBy).value();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderEaters(model) {
	  return [Cycle.h("h2", "Who's eating?"), Cycle.h("ul", [model.eaters.map(renderEater), Cycle.h("input.new-eater")])];
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var h = __webpack_require__(/*! ./h.js */ 23);
	var create = __webpack_require__(/*! ./create-element.js */ 24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! (webpack)/buildin/module.js */ 25)(module), (function() { return this; }()), __webpack_require__(/*! (webpack)/~/node-libs-browser/~/process/browser.js */ 28)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArray = __webpack_require__(/*! x-is-array */ 46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var applyProperties = __webpack_require__(/*! ./apply-properties */ 47);
